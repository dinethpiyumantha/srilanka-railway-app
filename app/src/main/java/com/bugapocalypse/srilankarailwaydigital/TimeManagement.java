 ...
 * Use the {@link TimeManagement#newInstance} factory method to
...
public class TimeManagement extends Fragment {
    ...
    public static TimeManagement newInstance(String param1, String param2) {
        TimeManagement fragment = new TimeManagement();
